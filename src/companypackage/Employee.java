...
public class Employee extends Card {
    ...
    public Employee(String typePayment) {
        constructEmployee(typePayment);
    }

    public Employee(String name, String address, String typePayment, String wayPayment, UnionContract union){
        this.name = name;
    ...
    private void constructEmployee(String typePayment){
        ...
        if(unionMember){
            ...
            setUnion(new UnionMember(unionFee, false, getName()));
        }
        else{
